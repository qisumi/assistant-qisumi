...
type Session struct {
	...
	Type      string    `gorm:"column:type;type:enum('task','global');not null;default:'task'" json:"type"` // "task" or "global"
...
type Message struct {
	...
	Role      string    `gorm:"column:role;type:enum('user','assistant','system');not null" json:"role"` // "user" | "assistant" | "system"
